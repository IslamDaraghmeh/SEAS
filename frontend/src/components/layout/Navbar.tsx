      ...
      <nav className="bg-white border-b border-gray-200 h-16">
        <div className="h-full px-4 sm:px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              className="lg:hidden p-2 rounded-xl text-gray-500 hover:text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors"
              onClick={onMenuClick}
            >
            ...
            >
              ...
              <span className="text-lg font-bold text-gray-900">SEAS</span>
            </Link>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Menu as="div" className="relative">
              <Menu.Button className="flex items-center gap-2 sm:gap-3 p-1.5 sm:p-2 rounded-xl hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors">
                {/* User Avatar */}
                <div className="relative">
                  ...
                  {/* Online indicator */}
                  <span className="absolute -bottom-0.5 -end-0.5 w-3 h-3 bg-green-400 border-2 border-white rounded-full" />
                </div>
              ...
              >
                <Menu.Items className="absolute end-0 mt-2 w-64 bg-white rounded-2xl shadow-xl ring-1 ring-black/5 focus:outline-none z-50 overflow-hidden">
                  {/* User info header */}
                  <div className="px-4 py-4 bg-gradient-to-r from-gray-50 to-gray-100/50 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <span className="inline-flex items-center mt-1 px-2 py-0.5 text-[10px] font-medium bg-white text-gray-600 rounded-md border border-gray-200 shadow-sm">
                          {t(`auth.${user?.role}`)}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="p-2">
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        ...
                        >
                          <span className={`p-1.5 rounded-lg ${active ? 'bg-red-100' : 'bg-red-50'}`}>
